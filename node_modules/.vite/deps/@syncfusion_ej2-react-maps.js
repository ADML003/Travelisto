import {
  SvgRenderer,
  Tooltip
} from "./chunk-XZEAZ4GJ.js";
import {
  PdfBitmap,
  PdfDocument,
  PdfPageOrientation
} from "./chunk-4U47OD6F.js";
import {
  DataManager,
  Query
...
var LayerDirective = (
  /** @class */
  function(_super) {
    __extends(LayerDirective2, _super);
...
var LayersDirective = (
  /** @class */
  function(_super) {
    __extends(LayersDirective2, _super);
...
var InitialShapeSelectionDirective = (
  /** @class */
  function(_super) {
    __extends2(InitialShapeSelectionDirective2, _super);
...
var InitialShapeSelectionsDirective = (
  /** @class */
  function(_super) {
    __extends2(InitialShapeSelectionsDirective2, _super);
...
var MarkerDirective = (
  /** @class */
  function(_super) {
    __extends3(MarkerDirective2, _super);
...
var MarkersDirective = (
  /** @class */
  function(_super) {
    __extends3(MarkersDirective2, _super);
...
var BubbleDirective = (
  /** @class */
  function(_super) {
    __extends4(BubbleDirective2, _super);
...
var BubblesDirective = (
  /** @class */
  function(_super) {
    __extends4(BubblesDirective2, _super);
...
var ColorMappingDirective = (
  /** @class */
  function(_super) {
    __extends5(ColorMappingDirective2, _super);
...
var ColorMappingsDirective = (
  /** @class */
  function(_super) {
    __extends5(ColorMappingsDirective2, _super);
...
var NavigationLineDirective = (
  /** @class */
  function(_super) {
    __extends6(NavigationLineDirective2, _super);
...
var NavigationLinesDirective = (
  /** @class */
  function(_super) {
    __extends6(NavigationLinesDirective2, _super);
...
var AnnotationDirective = (
  /** @class */
  function(_super) {
    __extends7(AnnotationDirective2, _super);
...
var AnnotationsDirective = (
  /** @class */
  function(_super) {
    __extends7(AnnotationsDirective2, _super);
...
var TextOption = (
  /** @class */
  /* @__PURE__ */ function() {
    function TextOption2(id, x, y, anchor, text, transform, baseLine) {
      if (transform === void 0) {
        transform = "";
      }
      this.transform = "";
...
var PathOption = (
  /** @class */
  /* @__PURE__ */ function() {
    function PathOption2(id, fill, width, color, fillOpacity, strokeOpacity, dashArray, d) {
      this.id = id;
...
var CircleOption = (
  /** @class */
  function(_super) {
    __extends8(CircleOption2, _super);
...
var PolygonOption = (
  /** @class */
  function(_super) {
    __extends8(PolygonOption2, _super);
...
var PolylineOption = (
  /** @class */
  function(_super) {
    __extends8(PolylineOption2, _super);
...
function markerTemplate(eventArgs, templateFn, markerID, data, markerIndex, markerTemplate2, location, transPoint, scale, offset, maps) {
...
var ZoomToolbarButtonSettings = (
  /** @class */
  function(_super) {
    __extends9(ZoomToolbarButtonSettings2, _super);
...
var ZoomToolbarTooltipSettings = (
  /** @class */
  function(_super) {
    __extends9(ZoomToolbarTooltipSettings2, _super);
...
var ZoomToolbarSettings = (
  /** @class */
  function(_super) {
    __extends9(ZoomToolbarSettings2, _super);
...
var CenterPosition = (
  /** @class */
  function(_super) {
    __extends9(CenterPosition2, _super);
...
var TooltipSettings = (
  /** @class */
  function(_super) {
    __extends9(TooltipSettings2, _super);
...
var PolygonTooltipSettings = (
  /** @class */
  function(_super) {
    __extends9(PolygonTooltipSettings2, _super);
...
var ConnectorLineSettings = (
  /** @class */
  function(_super) {
    __extends9(ConnectorLineSettings2, _super);
...
var MarkerClusterSettings = (
  /** @class */
  function(_super) {
    __extends9(MarkerClusterSettings2, _super);
...
var MarkerClusterData = (
  /** @class */
  function(_super) {
    __extends9(MarkerClusterData2, _super);
...
var ColorMappingSettings = (
  /** @class */
  function(_super) {
    __extends9(ColorMappingSettings2, _super);
...
var InitialMarkerSelectionSettings = (
  /** @class */
  function(_super) {
    __extends9(InitialMarkerSelectionSettings2, _super);
...
var InitialShapeSelectionSettings = (
  /** @class */
  function(_super) {
    __extends9(InitialShapeSelectionSettings2, _super);
...
var HighlightSettings = (
  /** @class */
  function(_super) {
    __extends9(HighlightSettings2, _super);
...
var PolygonSetting = (
  /** @class */
  function(_super) {
    __extends9(PolygonSetting2, _super);
...
var PolygonSettings = (
  /** @class */
  function(_super) {
    __extends9(PolygonSettings2, _super);
...
var NavigationLineSettings = (
  /** @class */
  function(_super) {
    __extends9(NavigationLineSettings2, _super);
...
var BubbleSettings = (
  /** @class */
  function(_super) {
    __extends9(BubbleSettings2, _super);
...
var CommonTitleSettings = (
  /** @class */
  function(_super) {
    __extends9(CommonTitleSettings2, _super);
...
var SubTitleSettings = (
  /** @class */
  function(_super) {
    __extends9(SubTitleSettings2, _super);
...
var TitleSettings = (
  /** @class */
  function(_super) {
    __extends9(TitleSettings2, _super);
...
var ZoomSettings = (
  /** @class */
  function(_super) {
    __extends9(ZoomSettings2, _super);
...
var ToggleLegendSettings = (
  /** @class */
  function(_super) {
    __extends9(ToggleLegendSettings2, _super);
...
var DataLabelSettings = (
  /** @class */
  function(_super) {
    __extends9(DataLabelSettings2, _super);
...
var ShapeSettings = (
  /** @class */
  function(_super) {
    __extends9(ShapeSettings2, _super);
...
var MarkerSettings = (
  /** @class */
  function(_super) {
    __extends9(MarkerSettings2, _super);
...
var LayerSettings = (
  /** @class */
  function(_super) {
    __extends9(LayerSettings2, _super);
...
var MapsAreaSettings = (
  /** @class */
  function(_super) {
    __extends9(MapsAreaSettings2, _super);
          ...
          var shapeRenderingSuccess = function(eventArgs2) {
            ...
            switch (drawingType) {
              case "Polygon":
                ...
                path += " z ";
                if (path.length > 3) {
                  pathOptions = new PathOption(shapeID, eventArgs2.fill, eventArgs2.border.width, eventArgs2.border.color, opacity, eventArgs2.border.opacity, shapeSettings.dashArray, path);
              ...
              case "LineString":
                ...
                if (path.length > 3) {
                  pathOptions = new PathOption(shapeID, "transparent", !isNullOrUndefined(eventArgs2.border.width) ? eventArgs2.border.width : 1, !isNullOrUndefined(eventArgs2.fill) ? eventArgs2.fill : eventArgs2.border.color, opacity, eventArgs2.border.opacity, shapeSettings.dashArray, path);
                  pathEle = _this.mapObject.renderer.drawPath(pathOptions);
                }
                break;
...
var Maps = (
  ...
  function(_super) {
    ...
    Maps2.prototype.getMarkerClickLocation = function(pageX, pageY, x, y, marker2, isDragEnd) {
      ...
      var targetElement = getElement(marker2.targetId);
      ...
      if (target.indexOf("_MarkerIndex_") > -1) {
        ...
        if (!isNaN(markerIndex)) {
          ...
          if (!marker2.template && target.indexOf("_cluster_") > -1 && this.maps.markerClusterExpand) {
            Array.prototype.forEach.call(marker2.dataSource, function(location, index2) {
    ...
    DataLabel2.prototype.renderLabel = function(layer, layerIndex, shape, layerData, group, labelTemplateElement, index, intersect) {
      ...
      if (!isNullOrUndefined(text) && !isNullOrUndefined(location)) {
        ...
        this.maps.trigger("dataLabelRendering", eventargs_1, function(labelArgs) {
          ...
          var position = [];
          var width = zoomLabelsPosition && scaleZoomValue > 1 && !_this.maps.zoomNotApplied && _this.maps.zoomShapeCollection.length > index ? _this.maps.dataLabelShape[index] * scale : (location["rightMax"]["x"] - location["leftMax"]["x"]) * scale;
          ...
          if (eventargs_1.template !== "") {
            ...
            if (zoomLabelsPosition && scaleZoomValue > 1 && !_this.maps.zoomNotApplied) {
              ...
              element.setAttribute("transform", "translate( " + ((location["x"] + transPoint.x) * scale + labelArgs.offsetX) + " " + ((location["y"] + transPoint.y) * scale + elementSize.height / 2 + labelArgs.offsetY) + " )");
            }
...
var Legend = (
  ...
  function() {
    ...
    Legend2.prototype.shapeHighLightAndSelection = function(targetElement, data, legendModule, getValue2, layerIndex) {
      if (data !== void 0) {
        this.updateLegendElement();
        this.shapeToggled = true;
        var collection = this.maps.legendModule.legendCollection;
        ...
        if (indexes["currentIndex"] === void 0 && getValue2 === "selection" && !this.maps.layers[layerIndex].selectionSettings.enableMultiSelect && targetElement.getAttribute("class") !== "ShapeselectionMapStyle") {
          this.maps.legendSelection = false;
        }
        if (getValue2 === "selection" && !this.maps.layers[layerIndex].selectionSettings.enableMultiSelect && !this.maps.legendSelection) {
          this.removeAllSelections();
          this.maps.legendSelection = true;
        }
        if (indexes["currentIndex"] === void 0) {
          if (getValue2 === "selection" && indexes["actualIndex"] !== void 0) {
        ...
        if (text === content) {
          ...
          if (getValue2 === "highlight" && shapeMatched) {
    ...
    Legend2.prototype.setToggleAttributes = function(textElement, shapeElement, fillColor, fillOpacity, borderColor, borderWidth, borderOpacity, textColor) {
...
var MapsComponent = (
  /** @class */
  function(_super) {
    __extends11(MapsComponent2, _super);
